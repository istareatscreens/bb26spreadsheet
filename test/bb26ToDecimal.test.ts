...
describe("#bb26ToDecimal", function(){
    //input test
    bb26toDecimalInputTest.forEach( ({input, result})=>context("with argument "+input, function(){
    ...
    //invalid input test
    bb26toDecimalInvalidInputTest.forEach( ({input, result,error})=>context("with invalid inputs", function(){
