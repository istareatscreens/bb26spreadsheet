...
describe("#bb26Range", function(){
    //input test
    bb26RangeInputTest.forEach( ({input, result})=>context("with argument "+input, function(){
        const {a, b} = input;
        ...
        //invalid input test
        bb26RangeInvalidInputTest.forEach( ({input, result,error})=>context("with invalid inputs", function(){
            const {a, b} = input;
